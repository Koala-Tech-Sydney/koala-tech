...
const tutorList = [
  {
    ...
    longDescription: (
      <SmallText>
        ...
        <br />
        <br />
        Nowadays, I have learnt more than a dozen languages, and a bunch of
        frameworks. What I find out is the crux of coding is not learning more
        and more languages or frameworks, but to understand the idea behind each
        language and framework. Each tool is built for some purposes, and
        whenever you learn a language or a framework that is built for a
        different purpose, you unlock a different way of thinking. So my
        suggestion is not to learn a new tool just because it looks cool but
        only if it helps you to complete a task in a way that is better than
        other tools.
        <br />
        <br />
