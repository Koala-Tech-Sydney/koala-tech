...
const Introduction = () => {
  return (
    <Chapter course={solidityCourse}>
      <Paragraph>
        We&apos;ll be starting our journey using a simple smart contract written
        in Solidity so as to give you a quick glance of the core building blocks
        of a Solidity smart contract. This smart contract can be used to store
        an integer on the blockchain.
      </Paragraph>
      <Paragraph>
        First of all, we need an IDE for writing Solidity contracts and
        we&apos;ll be using{" "}
        <Hyperlink href="https://remix.ethereum.org">Remix</Hyperlink>, which is
        a popular browser-based IDE specialized for writing smart contracts on
        Ethereum.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        sample files generated by Remix, most likely you won&apos;t need them.
        Now, paste the following content in{" "}
        <FeaturedText>Storage.sol</FeaturedText>.
      </Paragraph>
...
contract Storage {
    ...
    function retrieve() public view returns (uint256){
      ...
      <Paragraph>
        ...
        top which specifies the kind of license that your script has.
        That&apos;s because trust in smart contracts can be better established
        if their source code is available. Since making source code available
        always touches on legal problems with regards to copyright, the Solidity
      ...
      <Paragraph>
        ...
        way it&apos;s intended. The line below asks the compiler to use any of
        the Solidity versions larger than or equal to 0.6.0 but less than 0.9.0.
      </Paragraph>
      <SolidityFormatter
        showLineNumbers={false}
      ...
      <Paragraph>
        ...
        the contract is deployed on the Ethereum network. It&apos;s not required
        to name your contract the same as the name of your script but it&apos;s
    ...
    function retrieve() public view returns (uint256){
      ...
      <Paragraph>
        ...
        the higher the cost of interacting with the smart contract after
        it&apos;s deployed on the blockchain. If you are unfamiliar with the
        concepts we just said here, it&apos;s highly recommended for you to go
        through our <Link href="/courses/blockchain">blockchain course</Link>.
        In short, you need to pay for deploying a smart contract on a blockchain
        or modifying the state variables in a contract after it&apos;s deployed,
        these fees are called the transaction fees and the currency you are
        using to pay on the Ethereum blockchain is called ether.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        the compiled contract that you want to deploy, in this case, it&apos;s
        our Storage contract. After selecting the right contract, you can
        proceed to press the <FeaturedText>Deploy</FeaturedText> button.
      </Paragraph>
      <Image
      ...
      <Paragraph>
        ...
        the state variables in the blockchain and you don&apos;t need to pay a
        gas fee to call them.
      </Paragraph>
      <Image
      ...
      <Paragraph>
        ...
        default value of an integer if you didn&apos;t initialize it when you
        deploy the contract.
      </Paragraph>
      <Image
      ...
      />
      <Paragraph>
        Now if you call the retrieve function again, it&apos;ll show the new
        value 99.
      </Paragraph>
      <Image
